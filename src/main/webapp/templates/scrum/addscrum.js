...
.factory('addScrumService', ['$http', '$q', function ($http, $q) {
    ...
    var ADD_SCRUM_URI = 'http://127.0.0.1:8080/ScrumBoard/rest/services/scrum/';
    var UPDATE_SCRUM_URI = 'http://127.0.0.1:8080/ScrumBoard/rest/services/updateScrum/';
    var GET_RECENT_SCRUM_RECORD = 'http://127.0.0.1:8080/ScrumBoard/rest/services/latestScrum?';
