...
.factory('scrumService', ['$http', '$q', function ($http, $q) {
    ...
    var GET_SCRUM_DETAILS_URI = 'http://127.0.0.1:8080/ScrumBoard/rest/services/scrumdetails';
    var GET_FILTERED_SCRUM_DETAILS_URI = 'http://127.0.0.1:8080/ScrumBoard/rest/services/filteredscrumdetails';
