...
.service('SharedService', ['$state', 'growl', '$http', '$q', '$window', function ($state, growl, $http, $q, $window) {
    ...
    var GET_ALL_PROJECTS_URI = 'http://127.0.0.1:8080/ScrumBoard/rest/services/projects/';
    var SEARCH_ASSOCIATES_URI = 'http://127.0.0.1:8080/ScrumBoard/rest/services/searchAssociate?';
